...
token = '8885eb614287605057f573574c0d6701'
def use_token(token):
    ...
    if auth_response.status_code == 200:
        ...
        #ABTS LOS MANOLOS, ABTS SAN JUDAS
        name="presidente 61 Miami ZD0122400016"
        #name='ABTS TRIKIS'
        new_url = f"https://{api_host}{new_api_endpoint}?count={count_parameter}&start={start_parameter}&name={name}"
        new_headers = {
            'username': username,
            'token': token
        }
